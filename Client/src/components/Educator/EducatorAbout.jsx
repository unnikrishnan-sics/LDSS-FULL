...
const EducatorAbout = () => {
  ...
  return (
    <>
      <EducatorNavbar aboutBg={aboutBg} educatorDetails={educatorDetails}/>
      <Box display={"flex"} justifyContent={"center"} alignItems={"center"} sx={{
            ...
            <Box display={"flex"} alignItems={"center"} justifyContent={"space-around"} sx={{ height: "700px",backgroundImage:`url(${aboutbg1})`,backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:"center"}}>
