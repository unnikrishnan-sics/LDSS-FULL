...
const Footer = () => {
    return (
        <>
            <Container maxWidth={false} disableGutters  sx={{ backgroundColor: "#293460",margin:0,padding:0,height:"auto",position:"absolute"}}>
                ...
                <Stack sx={{
                    display: "flex", flexDirection: "row",justifyContent:"space-between",paddingTop:"20px",paddingLeft:"50px",paddingBottom:"0px",mb:"0px"
                }}>
                    <Box sx={{}}>
                        <Typography sx={{ color: 'white', fontSize: "14px", fontWeight: "500" }}>Copy right @2024. All rights reserved</Typography>
                    </Box>
                    <Box sx={{display: "flex", flexDirection: "row",marginLeft:"50px",paddingRight:"50px",gap:"20px",mb:"20px"}}>
