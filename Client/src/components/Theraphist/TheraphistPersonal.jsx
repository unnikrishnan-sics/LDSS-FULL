        ...
        <>
            ...
            <Container sx={{ position: "relative" }} maxWidth="x-lg">
                ...
                <Box display={'flex'} alignItems={'center'} justifyContent={'center'} flexDirection={'column'}>
                    <Typography variant='h2' color='primary' sx={{ fontSize: "32px", fontWeight: "600", marginTop: "100px", marginBottom:"40px" }}>Personal info</Typography>
                    ...
                    <Box display={'flex'} alignItems={'center'} justifyContent={'center'} flexDirection={'column'} sx={{ width: '253px', gap: '10px' }}>
                        <Button variant='contained' color='secondary' sx={{ borderRadius: "25px", marginTop: "50px", height: "40px", width: '150px', padding: '10px 35px' }}>Confirm</Button>
